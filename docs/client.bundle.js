 ...
 */
      ...
      { 'base64-js': 5, buffer: 8, ieee754: 30, isarray: 32 },
    ],
    9: [
      function(require, module, exports) {
        /**
    ...
    13: [
      function(require, module, exports) {
        ...
        function Socket(uri, opts) {
          ...
          this.hostname =
            opts.hostname || (typeof location !== 'undefined' ? location.hostname : 'localhost');
          this.port =
            opts.port ||
    ...
    14: [
      ...
      { 'component-emitter': 10, 'engine.io-parser': 24 },
    ],
    15: [
      function(require, module, exports) {
        /**
      ...
      function(require, module, exports) {
        ...
        function XHR(opts) {
          ...
          if (typeof location !== 'undefined') {
            ...
            this.xd =
              (typeof location !== 'undefined' && opts.hostname !== location.hostname) ||
              port !== opts.port;
              ...
              xhr.onreadystatechange = function() {
                if (xhr.readyState === 2) {
                  try {
                    ...
                    if (
                      (self.supportsBinary && contentType === 'application/octet-stream') ||
      ...
      function(require, module, exports) {
        ...
        exports.encodePayload = function(packets, supportsBinary, callback) {
          ...
          function encodeOne(packet, doneCallback) {
            exports.encodePacket(packet, !isBinary ? false : supportsBinary, false, function(
              message,
            ) {
    ...
    37: [
      ...
      { './manager': 38, './socket': 40, './url': 41, debug: 42, 'socket.io-parser': 46 },
    ],
    38: [
      function(require, module, exports) {
        /**
    ...
    41: [
      function(require, module, exports) {
        ...
        function url(uri, loc) {
          ...
          // define href
          obj.href =
            obj.protocol + '://' + host + (loc && loc.port === obj.port ? '' : ':' + obj.port);

          return obj;
        }
      },
      { debug: 42, parseuri: 35 },
    ],
    42: [
      function(require, module, exports) {
        arguments[4][21][0].apply(exports, arguments);
      },
      { './common': 43, _process: 36, dup: 21 },
    ],
    43: [
      function(require, module, exports) {
    ...
    46: [
      ...
      { './binary': 45, './is-buffer': 47, 'component-emitter': 10, debug: 48, isarray: 50 },
    ],
    47: [
      function(require, module, exports) {
        (function(Buffer) {
    ...
    53: [
      ...
      { './scripts/util/apiService': 54, './scripts/util/storage': 55, 'socket.io-client': 37 },
    ],
    54: [
      function(require, module, exports) {
        'use strict';
